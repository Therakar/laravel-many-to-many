          ...
          >
            <div class="position-sticky pt-3">
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    {{-- Route::currentRouteName() restituisce la rotta corrente, e serve per evidenziare la rotta di menu (nell'aside) in cui mi trovo--}}
                    <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.projects.index' ? 'bg-secondary' : '' }}" href="{{route('admin.projects.index')}}"> 
                        <i class="fa-solid fa-diagram-project fa-lg fa-fw"></i>
                        Projects
                    </a>
                </li>
